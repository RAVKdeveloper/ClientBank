...
const TComponent = dynamic(() => import('@/src/shared/TComponent/translateClient.shared'), { ssr: true })
...
export const AuthForm: FC = () => {
    ...
    const errorTextEmail = isValidEmail ? <TComponent str='auth.errors.emptyEmail' lng={language} /> : ''
    ...
    return (
        ...
        <Box 
         ...
         >
           ...
           >
           <Box sx={{ width: '100%' }}>
             <LabelFields label={<TComponent str={'auth.form.loginFormLabel'} lng={language ?? 'ru'} />} />
             <TextField 
              required 
              error={isValidEmail}
           ...
           <Box 
            ...
            <Link href={urlRegistr}>
              <Typography sx={{ ':hover': { textDecoration: 'underline' }, color: 'var(--color-accent)' }}>
